package ru.profiteam.admin.data.generator;
...
import ru.profiteam.admin.data.Role;
import ru.profiteam.admin.data.entity.SamplePerson;
import ru.profiteam.admin.data.entity.User;
import ru.profiteam.admin.data.service.SamplePersonRepository;
import ru.profiteam.admin.data.service.UserRepository;
    ...
    public CommandLineRunner loadData(PasswordEncoder passwordEncoder, SamplePersonRepository samplePersonRepository,
        ...
        return args -> {
            ...
            ExampleDataGenerator<SamplePerson> samplePersonRepositoryGenerator = new ExampleDataGenerator<>(
                    SamplePerson.class, LocalDateTime.of(2022, 7, 21, 0, 0, 0));
