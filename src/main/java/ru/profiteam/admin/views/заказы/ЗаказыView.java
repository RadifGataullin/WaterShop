package ru.profiteam.admin.views.заказы;
...
@PageTitle("Заказы")
@Route(value = "orders/:samplePersonID?/:action?(edit)", layout = MainLayout.class)
@AnonymousAllowed
@Uses(Icon.class)
public class ЗаказыView extends Div implements BeforeEnterObserver {

    private final String SAMPLEPERSON_ID = "samplePersonID";
    private final String SAMPLEPERSON_EDIT_ROUTE_TEMPLATE = "orders/%s/edit";
    ...
    @Autowired
    public ЗаказыView(SamplePersonService samplePersonService) {
