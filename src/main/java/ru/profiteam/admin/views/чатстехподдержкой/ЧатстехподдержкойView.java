package ru.profiteam.admin.views.чатстехподдержкой;
...
@PageTitle("Чат с техподдержкой ")
@Route(value = "chat-with-tech-support", layout = MainLayout.class)
@AnonymousAllowed
public class ЧатстехподдержкойView extends VerticalLayout {

    public ЧатстехподдержкойView() {
        addClassName("чатстехподдержкой-view");
        setSpacing(false);
