package ru.profiteam.admin.views.клиенты;
...
@AnonymousAllowed
@Uses(Icon.class)
public class КлиентыView extends Div implements BeforeEnterObserver {
    ...
    @Autowired
    public КлиентыView(SamplePersonService samplePersonService) {
        this.samplePersonService = samplePersonService;
        addClassNames("клиенты-view");
        ...
        grid.asSingleSelect().addValueChangeListener(event -> {
            if (event.getValue() != null) {
                ...
                clearForm();
                UI.getCurrent().navigate(КлиентыView.class);
            }
        });
    ...
    public void beforeEnter(BeforeEnterEvent event) {
        ...
        if (samplePersonId.isPresent()) {
            ...
            if (samplePersonFromBackend.isPresent()) {
                ...
                // refresh grid
                refreshGrid();
                event.forwardTo(КлиентыView.class);
            }
        }
    }
